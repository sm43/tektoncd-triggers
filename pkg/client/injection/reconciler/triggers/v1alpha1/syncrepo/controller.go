...
import (
	...
	syncrepo "github.com/tektoncd/triggers/pkg/client/injection/informers/triggers/v1alpha1/syncrepo"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "syncrepo-controller"
	defaultFinalizerName       = "syncrepos.triggers.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	syncrepoInformer := syncrepo.Get(ctx)

	lister := syncrepoInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "triggers.tekton.dev.SyncRepo"),
	)
